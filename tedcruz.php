...
$requestMethod = "GET";
if (isset($_GET['user']))  {$user = $_GET['user'];}  else {$user  = "TedCruz";}
...
foreach($string as $items)
    {
        ...
        echo "<div class='location'>Location: ".$items['place']['name']."</div>";
        echo "<div class='location'>Location: ".$items['place']['place_type']."</div>";
